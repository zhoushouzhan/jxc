 ...
 * @LastEditTime: 2022-09-19 08:11:11
 * @FilePath: \ypcmsvue3\src\pages\icon\add.vue
 * @Description:
 * 联系QQ:58055648
  ...
  <yplayout>
    ...
    <template #list>
      <div class="overflow-auto bg-white select-none p-2">
        ...
        <div class="flex py-2">
          <div class="w-24 text-right pr-5">字符</div>
          <div class="flex-1">
...
const isreset = ref(0)
const save = async () => {
  const res= await postData('/icon/save', formData)
  if(res.code) {
